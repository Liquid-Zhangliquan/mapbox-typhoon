...
export default class TyphoonCurrentLayer {
    ...
    update(typhoonCurrentPoint) {
        ...
        this.typhoonMarker && this.typhoonMarker.setLngLat([+typhoonCurrentPoint.longitude, +typhoonCurrentPoint.latitude])
    }
    ...
    generateTyphoonMarker(typhoonCurrentPoint) {
        ...
        return new mapboxgl.Marker(ele)
            .setLngLat([+typhoonCurrentPoint.longitude, +typhoonCurrentPoint.latitude])
            .addTo(this.map);
